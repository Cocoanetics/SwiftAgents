...
public struct ToolResources: Codable {
	...
	public init(from decoder: Decoder) throws {
		...
		self.codeInterpreter = try container.decodeIfPresent(CodeInterpreter.self, forKey: .codeInterpreter)
		self.fileSearch = try container.decodeIfPresent(FileSearch.self, forKey: .fileSearch)
		self.vectorStores = try container.decodeIfPresent([VectorStoreFiles].self, forKey: .vectorStores)
	}
	...
	private enum CodingKeys: String, CodingKey {
		...
		case vectorStores = "vectorStores"
	}
}
