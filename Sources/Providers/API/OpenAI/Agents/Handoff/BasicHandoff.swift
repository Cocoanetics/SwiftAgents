...
public struct BasicHandoff: Handoff {
    ...
    public init(
        ...
        toolName = toolNameOverride ?? "transfer_to_\(targetAgent.name.formattedToolName)"
        toolDescription = toolDescriptionOverride ?? targetAgent.defaultHandoffDescription
