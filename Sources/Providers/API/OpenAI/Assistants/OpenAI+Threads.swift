...
public extension OpenAI {
    ...
    func createThread(
        ...
        let request = try createUrlRequest(httpMethod: "POST", path: "/v1/threads", body: details)
    ...
    func retrieveThread(id: String) async throws -> Thread {
        let request = try createUrlRequest(path: "/v1/threads/" + id)
    ...
    func modifyThread(
        ...
        let request = try createUrlRequest(httpMethod: "POST", path: "/v1/threads/" + id, body: threadDetails)
     ...
     */
    @discardableResult
    internal func deleteThread(id: String) async throws -> Bool {
        let request = try createUrlRequest(httpMethod: "DELETE", path: "/v1/threads/" + id)
