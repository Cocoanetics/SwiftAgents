...
public extension OpenAI {
    ...
    func createConversation(
        ...
        let request = try createUrlRequest(httpMethod: "POST", path: "/v1/conversations", body: details)
    ...
    func retrieveConversation(id: String) async throws -> Conversation {
        let request = try createUrlRequest(path: "/v1/conversations/" + id)
    ...
    func updateConversation(
        ...
        let request = try createUrlRequest(httpMethod: "POST", path: "/v1/conversations/" + id, body: details)
    ...
    func deleteConversation(id: String) async throws -> Bool {
        let request = try createUrlRequest(httpMethod: "DELETE", path: "/v1/conversations/" + id)
