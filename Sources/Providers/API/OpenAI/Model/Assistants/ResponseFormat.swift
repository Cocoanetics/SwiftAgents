...
public enum ResponseFormat: Codable {
    ...
    /// Initializes from decoder attempting to discern between the string "auto" and dictionary types for "text" and
    /// "json_object".
        ...
        if let stringValue = try? container.decode(String.self) {
            switch stringValue {
                ...
                default:
                    throw DecodingError.dataCorruptedError(
                        in: container,
                        debugDescription: "Invalid value for ResponseFormat"
                    )
            }
        } else {
            ...
            switch dictValue["type"] {
                ...
                default:
                    throw DecodingError.dataCorruptedError(
                        in: container,
                        debugDescription: "Invalid type for ResponseFormat dictionary"
                    )
            }
        }
    }
