...
public struct RunCreation: Codable {
    ...
    /// Optional: The ID of the Model to be used to execute this run. If provided, it will override the model associated
    /// with the assistant.
    public let model: String?
    ...
    /// Optional: Appends additional instructions at the end of the instructions for the run. Useful for modifying the
    ...
    /// Optional: Override the tools the assistant can use for this run. Useful for modifying the behavior on a per-run
    /// basis.
    public let tools: [ToolDescription]?
