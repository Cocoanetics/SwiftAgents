...
public struct ChatMessage: Codable, Sendable {
    ...
    /// The contents of the message. It's optional, because if there's a function call response, then content will be
    /// null
...
public extension ChatMessage {
    var textContent: String? {
        ...
        if case let .text(string) = content {
            return string
        }
        return nil
    }
...
public extension ChatMessage {
    struct ContentPart: Codable, Sendable {
                ...
                switch raw {
                    ...
                    default:
                        throw DecodingError.dataCorruptedError(
                            in: container,
                            debugDescription: "Unknown content part type \(raw)"
                        )
                }
            }
        ...
        public init(inputAudioData: String, format: String) {
            ...
            text = nil
            imageURL = nil
            inputAudio = InputAudio(data: inputAudioData, format: format)
            file = nil
        }
        ...
        public init(fileID: String? = nil, filename: String? = nil, fileData: String? = nil) {
            ...
            imageURL = nil
            inputAudio = nil
            file = FilePart(fileID: fileID, filename: filename, fileData: fileData)
        }
