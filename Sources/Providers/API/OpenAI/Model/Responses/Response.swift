...
extension Response {
	...
	public enum FileSearchCallType: String, Codable, Sendable {
		case fileSearchCall = "file_search_call"
	}

	public enum FunctionCallType: String, Codable, Sendable {
		case functionCall = "function_call"
	}

	public enum FunctionCallOutputType: String, Codable, Sendable {
		case functionCallOutput = "function_call_output"
	}

	public enum WebSearchCallType: String, Codable, Sendable {
		case webSearchCall = "web_search_call"
	}

	public enum ComputerCallType: String, Codable, Sendable {
		case computerCall = "computer_call"
	}

	public enum ComputerCallOutputType: String, Codable, Sendable {
		case computerCallOutput = "computer_call_output"
	}

	public enum ComputerScreenshotType: String, Codable, Sendable {
		case computerScreenshot = "computer_screenshot"
	}

	public enum ItemReferenceType: String, Codable, Sendable {
		case itemReference = "item_reference"
	}

	public enum ApplyPatchCallOutputType: String, Codable, Sendable {
	...
	public enum ApplyPatchResultStatus: String, Codable, Sendable {
		case completed
		case failed
	}
