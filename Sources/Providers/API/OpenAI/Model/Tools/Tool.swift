...
public enum Tool: Codable, Sendable {
	...
	public init(from decoder: Decoder) throws {
		...
		case "function":
			...
			self = .function(FunctionTool(name: name, description: description, parameters: parameters, strict: false))
		case "file_search":
		...
		case "mcp":
			...
			self = .mcp(MCPRemoteTool(serverLabel: serverLabel, serverURL: serverURL, requireApproval: requireApproval, allowedTools: allowedTools))
		case "apply_patch":
			self = .applyPatch
		default:
