...
public struct VectorStore: Codable {
	...
	///
	/// The set of metadata key-value pairs can be attached to a vector store object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long, and values can be a maximum of 512 characters long.
 ...
 */
internal struct VectorStoreOptionals: Codable {
	/// Optional name of the vector store.
	public let name: String?
