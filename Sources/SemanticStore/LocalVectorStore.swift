...
/// One `LocalVectorStore` search hit.
...
public class LocalVectorStore {
    ...
    public init(embeddingProvider: EmbeddingProvider? = nil) {
    ...
    public func indexText(_ text: String, source: String) async throws {
        #if canImport(NaturalLanguage)
    ...
    public func search(text: String, topN: Int) async throws -> [TextFragment] {
